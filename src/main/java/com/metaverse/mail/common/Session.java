 ...
 * 사용자 세션 관리 클래스
 * 
 * <p>이 클래스는 애플리케이션 내에서 현재 로그인한 사용자 정보를 관리합니다.
 * 싱글톤 패턴을 사용하여 애플리케이션 전체에서 하나의 세션 인스턴스만 유지됩니다.</p>
 * 
 * <p>주요 기능:</p>
 * <ul>
 *   <li>사용자 로그인 상태 관리</li>
 *   <li>현재 로그인한 사용자 정보 제공</li>
 *   <li>로그아웃 처리</li>
 * </ul>
 * 
 * @author 이메일 관리 시스템 팀
...
public class Session {
     ...
     * 싱글톤 인스턴스를 반환합니다.
     * 
     * <p>인스턴스가 없는 경우 새로 생성하여 반환합니다(지연 초기화).
     * 이 메서드를 통해서만 Session 객체에 접근할 수 있습니다.</p>
     * 
     * @return Session 인스턴스
     */
     ...
     * 사용자 로그인 처리를 수행합니다.
     * 
     * <p>사용자 객체가 유효한 경우, 해당 사용자 정보를 세션에 저장하고
     * 로그인 상태를 true로 변경합니다.</p>
     * 
     ...
     * 로그아웃 처리를 수행합니다.
     * 
     * <p>현재 사용자 정보를 초기화하고 로그인 상태를 false로 변경합니다.</p>
     */
    public void logout() {

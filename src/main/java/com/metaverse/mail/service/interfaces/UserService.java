 ...
 * 
 * <p>이 인터페이스는 사용자 계정 관리와 관련된 비즈니스 로직을 정의합니다.
 * 사용자 인증, 계정 생성, 정보 수정, 비밀번호 변경, 계정 비활성화 등의
 * 기능을 포함합니다.</p>
 * 
 * <p>서비스 계층은 프레젠테이션 계층(View)과 데이터 액세스 계층(DAO) 사이의
 * 중간 역할을 하며, 비즈니스 규칙 및 트랜잭션 처리를 담당합니다.</p>
 * 
 * <p>담당 개발자: 우선(개발자 A)</p>
 * 
 * @author 이메일 관리 시스템 팀
...
public interface UserService {
     ...
     * 회원가입 처리
     * 
     * <p>새로운 사용자 계정을 생성합니다. 입력받은 정보를 검증한 후
     * 유효한 경우 데이터베이스에 사용자 정보를 저장합니다.</p>
     * 
     * <p>주요 처리 내용:</p>
     * <ul>
     *   <li>이메일 형식 및 중복 검사</li>
     *   <li>비밀번호 유효성 검사 및 암호화</li>
     *   <li>필수 정보 입력 확인</li>
     *   <li>사용자 정보 저장</li>
     * </ul>
     * 
     ...
     * 로그인 처리
     * 
     * <p>사용자 인증을 수행합니다. 입력받은 이메일과 비밀번호를 검증하고
     * 유효한 경우 사용자 세션을 생성합니다.</p>
     * 
     * <p>주요 처리 내용:</p>
     * <ul>
     *   <li>이메일 존재 여부 확인</li>
     *   <li>비밀번호 일치 여부 확인</li>
     *   <li>계정 상태 확인(활성/비활성)</li>
     *   <li>로그인 성공 시 세션 정보 설정</li>
     * </ul>
     * 
     ...
     * 비밀번호 변경
     * 
     * <p>사용자의 비밀번호를 변경합니다. 현재 비밀번호 확인 후
     * 새 비밀번호로 업데이트합니다.</p>
     * 
     * <p>주요 처리 내용:</p>
     * <ul>
     *   <li>현재 비밀번호 일치 여부 확인</li>
     *   <li>새 비밀번호 유효성 검사</li>
     *   <li>비밀번호 암호화 및 업데이트</li>
     * </ul>
     * 
     ...
     * 회원 탈퇴 처리
     * 
     * <p>사용자 계정을 비활성화 상태로 변경합니다. 실제로 데이터는 삭제되지 않고
     * 상태만 변경되어 나중에 복구 가능합니다.</p>
     * 
     * <p>주요 처리 내용:</p>
     * <ul>
     *   <li>사용자 존재 여부 확인</li>
     *   <li>사용자 상태를 비활성화로 변경</li>
     *   <li>사용자 세션 종료</li>
     * </ul>
     * 
